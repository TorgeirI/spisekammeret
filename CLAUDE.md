...
- [x] Kjernemodeller — C# domeneklasser + Schema.org-mapping (`Spisekammeret.Core`)
- [x] Database — EF Core schema, migrasjoner, PostgreSQL (`Spisekammeret.Infrastructure`)
- [x] API — CRUD endpoints + OpenAPI (`Spisekammeret.Api`)
- [x] Import + LLM — scraper + Claude API-integrasjon
